...
#a=1.31434
#b=3
#c=round(a*b,5)# round округление числа, если требуется знаки поле запятой, после последней переменной пишем (,3)
#print(c)
...
#is_odd=f[0]%2==0#обращаемся к первому элементу списка под индексом 0(f[0]) и находим остаток от деление % на 2 равый нулю(==0)
#print(is_odd)
